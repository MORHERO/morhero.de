    ...
    public function block_input($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["key"] => $context["item_value"]) {
            ...
            if ((twig_test_iterable($context["item_value"]) && $this->getAttribute($context["item_value"], "value", array()))) {
                // line 34
                echo "                    ";
                $context["akey"] = ((($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "selectize", array()) && $this->getAttribute((isset($context["field"]) ? $context["field"] : null), "multiple", array()))) ? ($context["item_value"]) : ($context["key"]));
                // line 35
                echo "                    ";
                $context["avalue"] = (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) ? ($this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter($this->getAttribute($context["item_value"], "value", array()))) : ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($this->getAttribute($context["item_value"], "value", array()))));
                // line 36
                echo "                    <option ";
...
\t\t\t    value=\"";
                ...
                echo "\">";
                echo (isset($context["avalue"]) ? $context["avalue"] : null);
                echo "</option>
                ";
...
{% endblock %}
", "forms/fields/select/select.html.twig", "/opt/lampp/htdocs/morhero.de/grav/user/plugins/form/templates/forms/fields/select/select.html.twig");
    }
}
